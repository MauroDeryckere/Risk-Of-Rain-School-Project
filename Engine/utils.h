...
#pragma region CollisionFunctionality
	...
	bool IsOverLappingPolygon(const std::vector<Point2f>& vertices, const Rectf& r);
...
#pragma region Beziers 
	Point2f PointOnLinearBezier(const LinearBezier& bez, float t);
	Point2f PointOnQuadraticBezier(const QuadraticBezier& bez, float t);
	Point2f PointOnCubicBezier(const CubicBezier& bez, float t);

	Point2f PointOnLinearBezier(const Point2f& p0, const Point2f& p1, float t);
	Point2f PointOnQuadraticBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2, float t);
	Point2f PointOnCubicBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2, const Point2f& p3, float t);

	float AngleRCubicBezier(const CubicBezier& bez, float t);
	float AngleDCubicBezier(const CubicBezier& bez, float t);

	float AngleRCubicBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2, const Point2f& p3, float t);
	float AngleDCubicBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2, const Point2f& p3, float t);
