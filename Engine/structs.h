...
{
	LinearBezier();
	explicit LinearBezier(const Point2f& p0, const Point2f& p1);
...
{
	QuadraticBezier();
	explicit QuadraticBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2);
...
{
	CubicBezier();
	explicit CubicBezier(const Point2f& p0, const Point2f& p1, const Point2f& p2, const Point2f& p3);
